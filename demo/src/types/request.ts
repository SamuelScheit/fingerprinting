...
export class FingerprintPayload {
	/** api key */
	...
	s34 = (o: Option) => {
		switch (o) {
			...
			case Option.successRandom:
				return {
					s: 0,
					v: [`candidate:2079771436 1 udp 2122260223 169.254.25.252 50012 typ host generation 0 ufrag qRGm network-id 3`],
				};
			case Option.successStatic:
				return {
					s: 0,
					v: [
