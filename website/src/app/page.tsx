      ...
      <main className="flex min-h-screen flex-col items-center justify-center text-white">
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
          ...
          <div className="text-center text-xl leading-relaxed text-gray-300">
            Fingerprint is a unique identifier based on your browser and device
            configuration.
            <br />
            This identifier can be used to track you across different websites
            and build a profile of your online activity.
          </div>
